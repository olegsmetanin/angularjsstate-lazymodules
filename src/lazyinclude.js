...
(function() {
    ...
    var aModule = angular.module('lazyinclude', []);

    aModule.factory('scriptCache', ['$cacheFactory',
    ...
    aModule.provider('$lazyinclude', ['$controllerProvider', '$provide', '$compileProvider', '$filterProvider',
    ...
    aModule.directive('ngLazyinclude', ['$http', 'scriptCache', '$log', '$lazyinclude', '$compile', '$timeout',
        function($http, scriptCache, $log, $lazyinclude, $compile, $timeout) {
            return {
                link: function(scope, element, attr) {
                    var srcExp = attr.module,
                        templateId = attr.ngLazyinclude,
                        childScope;
                    ...
                    scope.$watch(srcExp, function(moduleName) {
                        var moduleConfig = $lazyinclude.getConfig(moduleName);

                        if (moduleName) {
                            $lazyinclude.load(moduleName, function() {
